...
Int_t THaSpectrometer::DefineVariables( EMode mode )
{
  ...
  RVarDef vars[] = {
    ...
    { "tr.trknum", "Track Number",               "fTracks.THaTrack.fTrkNum"},
    { "tr.U1clsnum", "U1 Cluster Number",        "fTracks.THaTrack.fU1Num"},
    { "tr.V1clsnum", "V1 Cluster Number",        "fTracks.THaTrack.fV1Num"},
    { "tr.U2clsnum", "U2 Cluster Number",        "fTracks.THaTrack.fU2Num"},
    { "tr.V2clsnum", "V2 Cluster Number",        "fTracks.THaTrack.fV2Num"},    
    { "tr.UV12_X",  "X lower chamber",           "fTracks.THaTrack.fUV12X"},
    { "tr.UV12_Y",  "Y lower chamber",           "fTracks.THaTrack.fUV12Y"},
    { "tr.UV12_PX",  "Proj X  in lower chamber", "fTracks.THaTrack.fUV12PX"},
    { "tr.UV12_PY",  "Proj Y  in lower chamber", "fTracks.THaTrack.fUV12PY"},
    { "tr.UV12_th",  "theta  in lower chamber",  "fTracks.THaTrack.fUV12Theta"},
    { "tr.UV12_ph",  "phi  in lower chamber",    "fTracks.THaTrack.fUV12Phi"},
    { "tr.UV21_X",  "X upper chamber",           "fTracks.THaTrack.fUV21X"},
    { "tr.UV21_Y",  "Y upper chamber",           "fTracks.THaTrack.fUV21Y"},
    { "tr.UV21_PX",  "Proj X  in upper chamber", "fTracks.THaTrack.fUV21PX"},
    { "tr.UV21_PY",  "Proj Y  in upper chamber", "fTracks.THaTrack.fUV21PY"},
    { "tr.UV21_th",  "theta  in upper chamber",  "fTracks.THaTrack.fUV21Theta"},
    { "tr.UV21_ph",  "phi  in upper chamber",    "fTracks.THaTrack.fUV21Phi"},
    { "tr.gom",   "Goodness of match",           "fTracks.THaTrack.fError"},
    { "tr.toff",  "Average of timing offsets",   "fTracks.THaTrack.GetToff()"},
    ...
    { "tr.a_vx",  "AltVertex x (m)",             "fTracks.THaTrack.GetAltVertexX()"},
    { "tr.a_vy",  "AltVertex y (m)",             "fTracks.THaTrack.GetAltVertexY()"},
    { "tr.a_vz",  "AltVertex z (m)",             "fTracks.THaTrack.GetAltVertexZ()"},
